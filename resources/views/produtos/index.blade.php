                ...
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    ...
                    @if(count($produtos) > 0)
                        <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                            <h4 class="font-semibold text-gray-800 dark:text-white">Produtos Pendentes:</h4>
                            <h3 class="text-gray-800 dark:text-white">
                                ...
                                Outros: <a class="text-red-500">{{ $outros }}</a>
                            </h3>
                        </div>
                    @endif
                    <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                @foreach ($produtos as $produto)
                                    ...
                                    <div id="editar-modal-{{ $produto->id }}" tabindex="-1" aria-hidden="true" class="hidden fixed inset-0 z-50 items-center justify-center overflow-y-auto overflow-x-hidden">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800 overflow-y-auto max-h-[90vh]">
                                                ...
                                                <div class="flex justify-between items-center p-4 border-b rounded-t dark:border-gray-600">
                                                    ...
                                                    <button type="button" class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" 
                                                        data-modal-toggle="editar-modal-{{ $produto->id }}">
                                        ...
                                        <div id="excluir-modal-{{ $produto->id }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full bg-black bg-opacity-30">
                                                ...
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <form method="POST" action="{{ route('produtos.destroy', $produto->id) }}" class="p-6">
                                                        ...
                                                        <div class="p-4 md:p-5 text-center">                                                            
                                                            <img class="mx-auto h-auto rounded mb-4 text-gray-400 w-25 h-20 dark:text-gray-200" src="{{ asset('images/' . $produto->image)}}" alt="" >
                                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Deseja realmente deletar esse Produto?</h3>
                                                            <button data-modal-hide="excluir-modal-{{ $produto->id }}" type="submit" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                                                                Sim, deletar
                                                            </button>
                                                            <button data-modal-toggle="excluir-modal-{{ $produto->id }}" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                                                Não, cancelar
                                                            </button>
                                                        </div>
                                                    </form>
